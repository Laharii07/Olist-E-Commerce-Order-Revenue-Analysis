...
This project consists of a comprehensive suite of 50 SQL Business Intelligence queries designed to analyze an e-commerce marketplace (based on the Olist Brazilian E-Commerce dataset).

The project covers the entire analytical spectrum, from basic descriptive statistics to advanced predictive modeling and customer lifecycle analysis.
...
⏱️ Delivery Speed: Regional analysis of delivery times and state-by-state logistics benchmarking.
⭐ Trust & Satisfaction: Correlating delivery delays with review scores and tracking declining seller ratings over time.
⚠️ Risk Management: Analyzing refund and cancellation rates by product category.
...
🌦️ Seasonality: Identifying monthly order patterns to inform inventory and marketing spend.
###🛠️ Technical Skills Demonstrated
🧮 Window Functions: RANK(), DENSE_RANK(), NTILE(), LAG(), LEAD(), FIRST_VALUE(), SUM() OVER
...
📢 Marketing: Optimize acquisition budgets (CAC/CLV) and trigger win-back campaigns
⚙️ Operations: Identify logistics bottlenecks and improve delivery estimation accuracy
💳 Finance: Monitor growth velocity and ensure data integrity in payments
🛍️ Product: Understand category performance and improve marketplace trust
⭐ Why This Project Stands Out
🔥 Covers end-to-end analytics lifecycle
🧠 Demonstrates business + technical thinking
📈 Uses real-world messy dataset
💼 Portfolio-ready for Data Analyst / BI roles
🏁 Conclusion

This project showcases strong SQL expertise, analytical thinking, and the ability to translate data into business value 🚀
